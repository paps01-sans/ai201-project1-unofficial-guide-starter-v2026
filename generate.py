...
- If the documents do not directly answer the question, say you don't have enough information. Do not guess, infer, or fill gaps from general knowledge.
- Name the source filename immediately after the factual answer, using the filename given in the excerpt that supports it.
- Do not cite a document unless its excerpt supports the answer.
